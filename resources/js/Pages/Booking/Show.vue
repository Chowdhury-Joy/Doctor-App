    ...
    <div class="min-h-screen bg-gray-50 p-8 flex items-center justify-center">
        <div class="max-w-md w-full bg-white rounded-xl shadow-lg overflow-hidden">
            <div class="bg-blue-600 p-6 text-center text-white">
                ...
                <p class="text-blue-100 text-sm">Save this link or take a screenshot</p>
            </div>
            
            <div class="p-6">
                <div class="text-center mb-8">
                    <div class="text-sm text-gray-500 uppercase tracking-widest mb-1">Your Serial Number</div>
                ...
                <div class="bg-gray-50 rounded p-4 mb-6 text-center border">
                    <div class="text-xs text-gray-500 uppercase tracking-widest mb-1">Currently Serving</div>
                    <div class="text-3xl font-bold text-blue-600">
                        {{ nowServing === 0 ? 'Waiting to start' : '#' + nowServing }}
                    </div>
                </div>
                ...
                <div class="space-y-3 text-sm">
                    ...
                    <div class="flex justify-between border-b pb-2">
                        <span class="text-gray-500">Chamber</span>
